 ...
 */
public class  ControlPanelFeature extends PluginFeature {
	...
	public String getDescription(Locale locale) {
		if(locale.toString().toLowerCase().startsWith("ar"))
			return "LimitLess ControlPanel Feature";
		else
		return "LimitLess ControlPanel Feature";
	}
	...
	public String getIconUrl() {
		return "ControlPanelFeatureIcon";
	}
	...
	public String getContentClass() {
		return "limitLessDojo.ControlPanelFeature";
	}
