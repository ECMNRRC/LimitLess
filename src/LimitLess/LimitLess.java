...
import LimitLess.features.ControlPanelFeature;
/**
 ...
 * <p>
 */
public class LimitLess extends Plugin {
	...
	public String getName(Locale locale) {
		return "LimitLess"+ this.getVersion();
	}
	...
	public String getScript() {
		return "LimitLess"+ this.getVersion()+".js";
	}
	...
	public String getConfigurationDijitClass() {
		return "limitLessDojo.ConfigurationPane";
	}
